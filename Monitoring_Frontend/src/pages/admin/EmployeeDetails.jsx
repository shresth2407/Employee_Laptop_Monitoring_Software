          ...
          <div className="space-y-6">
            <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition-all hover:shadow-lg">
              ...
              <div className="relative -mt-12 flex flex-col items-center px-6 pb-8">
                ...
                <button
                  type="button"
                  onClick={() => navigate(`/admin/monitoring/${employee._id}`)}
                  className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-slate-900 py-3 text-sm font-bold text-white shadow-lg shadow-slate-200 transition hover:bg-slate-800 active:scale-95"
                >
